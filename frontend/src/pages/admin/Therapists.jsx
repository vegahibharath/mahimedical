...
.restricted-text::-webkit-scrollbar {
  width: 6px;
}
.restricted-text::-webkit-scrollbar-thumb {
  background: #adb5bd;
  border-radius: 4px;
}
`}
  ...
  <div className="modal d-block" style={{ background: "rgba(0,0,0,0.5)" }}>
    <div className="modal-dialog modal-lg modal-dialog-scrollable">
      <div className="modal-content">
        ...
        <div className="modal-header">
          <h5 className="modal-title">{viewData.name}</h5>
        </div>
    ...
    <p>
  <strong>Bio:</strong>
  <span className="restricted-text">{viewData.bio}</span>
</p>
